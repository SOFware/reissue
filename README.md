...
The workflow uses your Rakefile configuration for version file location and branch settings. Configure reissue in your Rakefile:
...
See `.github/workflows/SHARED_WORKFLOW_README.md` for detailed documentation.
